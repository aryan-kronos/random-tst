...
export default function CategoryHoverCard({
  ...
  return (
    <div
      ...
      className={`group relative rounded-3xl border bg-ivory/90 backdrop-blur-md overflow-hidden transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_20px_60px_-20px_rgba(45,36,24,0.35)] ${
        isFilterActive ? 'border-amber shadow-[0_10px_40px_-15px_rgba(196,162,101,0.5)] ring-2 ring-amber/20' : 'border-ink-wash/12'
      }`}
    >
